...
class PriceLabelPromoView extends StatelessWidget {
            ...
            return isWide
                ? Row(
                    ...
                    children: [
                      ...
                      Expanded(
                          child:
                              _buildPreviewSection2()), // Keep original preview
                    ],
                  )
                : Column(
                    children: [
                          ...
                          children: [
                            Expanded(
                                child: _editDescriptionWidget(
                                    Get.find<PriceLabelPromoController>(),
                                    constraints)),
                      ...
                      Expanded(
                          child:
                              _buildPreviewSection2()), // Keep original preview with Expanded
                    ],
                  );
          },
        ),
  ...
  Container _viewLabelsWidget(
      PriceLabelPromoController con, BoxConstraints constraints) {
    final isWide = constraints.maxWidth >= 1400;
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onDoubleTap: () => con.generatePriceLabelPromoData(),
              ...
              children: [
                ...
                ConstrainedBox(
                  constraints: const BoxConstraints(
                      maxHeight: 140), // Smaller for narrow screens
                      ...
                      return Padding(
                        ...
                        child: Obx(() => Row(
                              children: [
                                Text("${index + 1}: ",
                                    style:
                                        TextStyle(fontSize: isWide ? 14 : 11)),
                                Expanded(
                                  flex: 3, // Description gets more space
                                  child: SizedBox(
                                    height: isWide ? 30 : 25,
                                    child: TextFormFieldWidget2(
