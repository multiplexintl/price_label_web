...
class PriceLabelNonPromoView extends StatelessWidget {
                          ...
                          children: [
                            Expanded(
                                child: _editDescriptionWidget(
                                    Get.find<PriceLabelNoPromoController>(),
                                    constraints)),
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            // _preferenceWidget(con), // Only show on wide screens
          ],
        ),
      ),
    );
  ...
  // Container _preferenceWidget(PriceLabelNoPromoController con) {
  //   return Container(
  ...
  Container _viewLabelsWidget(
      PriceLabelNoPromoController con, BoxConstraints constraints) {
    final isWide = constraints.maxWidth >= 1400;
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () {
                                          con.editPriceLabelNoPromo(index);
                                        },
              ...
              children: [
                ...
                ConstrainedBox(
                  constraints: const BoxConstraints(
                      maxHeight: 150), // Smaller for narrow screens
                      ...
                      return Padding(
                        ...
                        child: Obx(() => Row(
                              children: [
                                Text("${index + 1}: ",
                                    style:
                                        TextStyle(fontSize: isWide ? 14 : 12)),
                                Expanded(
                ...
                // Action buttons - always stacked for narrow screens
                Column(
                  children: [
                    Row(
                      children: [
...
class PriceLabelPromoWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const totalHeight = 172.5;
    final itemCount = promo.items.length;
    final itemHeight = itemCount > 0 ? totalHeight / itemCount : 0;
